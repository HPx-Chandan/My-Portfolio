  ...
  return (
    <section className="hero overflow-hidden z-0">
      <Parallax pages={1.4}>
        ...
        <ParallaxLayer speed={0.1} offset={0}>
          ...
          >
            <Canvas>
              ...
              <Suspense
                fallback={
                  <p className="text-white text-center">Loading Model...</p>
                }
              >
                <PlaneAsteroid
                  scale={0.19}
        ...
        <ParallaxLayer speed={0.01} offset={0}>
          <p className="absolute top-52 lg:top-64 xl:top-72 ml-[52.8rem] w-[8rem] sm:w-[10rem] sm:ml-[46rem] lg:ml-[42.4rem] lg:w-[25rem] xl:ml-[36rem] xl:w-[36rem] text-base font-mono sm:text-lg text-black-200 mt-2">
        ...
        <ParallaxLayer speed={0.01}>
          <h1 className="hero-heading overflow-hidden lg:h-[3rem] sm:h-[2.5rem] h-[2.5rem] absolute top-36 lg:top-52 xl:top-60 font-bold text-4xl ml-[52.8rem] sm:ml-[46rem] lg:ml-[42.4rem] xl:ml-[36rem] lg:text-5xl text-[#E6E6FA]">
